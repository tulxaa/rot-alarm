...
def draw():
    ...
    if game_over:
        display_message("GAME OVER!", "Versuche es erneut, indem du auf die Leertaste drückst!.")
    elif game_complete:
        display_message("DU HAST GEWONNEN!", "Gut gemacht. Spiele erneut, indem du auf die Leertaste drückst!")
    else:
        for star in stars:
            star.draw()
